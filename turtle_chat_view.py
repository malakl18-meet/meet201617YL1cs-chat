...
class TextBox(TextInput):
    def draw_box(self):
        writer = turtle.clone()
        writer.goto(self.pos)
        writer.pendown()
        writer.goto(0,self.height)
        writer.goto(self.width,self.height)
        writer.goto(self.width,0)
        writer.goto(self.pos)
        writer.penup()
        
    def write_msg(self):
        self.setup_listeners()
        self.writer.goto(self.pos[0]+10,self.pos[1]+self.height-20)
