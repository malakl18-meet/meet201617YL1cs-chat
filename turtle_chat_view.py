...
class TextBox(TextInput):
    ...
    def write_msg(self):
        ...
        self.writer.penup()
        self.writer.goto(-140,self.height-20)
        self.writer.clear()
...
class SendButton(Button):
    def __init__(self,my_turtle=None,shape=None,pos=(100,-25),view=None):
        super(SendButton,self).__init__(my_turtle,shape)
        self.view=view
        self.pos=pos
        mama=turtle.clone()
        self.mama=mama
        self.mama.penup()
        self.mama.goto(100,-25)
        self.mama.pendown()
        self.mama.pencolor('white')
        self.mama.write("SEND" , font=('Arial',20))
...
class View:
    ...
    def __init__(self,username='Me',partner_name='Partner'):
        ...
        self.msg_turtles= []
        self.msg_turtles.append(turtle.clone())
        self.msg_turtles.append(turtle.clone())
        self.msg_turtles.append(turtle.clone())
        self.msg_turtles.append(turtle.clone())
...
##        toto = self.textbox.writer.clone()
##        self.toto=toto
##        for i in range(5):
##            self.msg_queue.insert(0,'')
##        for i in range(5):
##            self.toto.goto(0,self._LINE_SPACING*i)
##            self.toto.write(self.msg_queue[i])

        
        
        #for me in range(5):
            #self.msg_turtles[i].clear()
        
        for i in range(5):
            self.msg_turtles[i].hideturtle ()
            self.msg_turtles[i].penup()
            self.msg_turtles[i].goto(-130,120+i*self._LINE_SPACING)
            self.msg_turtles[i].clear()
            self.msg_turtles[i].pendown()
            self.msg_turtles[i].write(self.msg_queue[i])
...
##            self.msg_turtles.append(turtle.clone())
##            self.msg_turtles[i].hide.turtle()
##            self.msg_turtles[i].penup()
##            self.msg_turtles[i].goto(-130,120+(i+1)*self._LINE_SPACING)
##            self.msg_turtles[i].pendown()
##            self.msg_turtles[i].write(self.msg_queue[i+1])
